...
unit chHash.CRC.CRC16.TELEDISK.Factory;
...
constructor TchCrc16TELEDISK.Create;
begin
  inherited Create;
end;

initialization
  TchCrc16TELEDISK.FInstance := TchCrc16TELEDISK.Create;

{$IF NOT DEFINED(SUPPORTS_INTERFACES)}
finalization
  FreeAndNil(TchCrc16TELEDISK.FInstance);
{$ENDIF ~ NOT SUPPORTS_INTERFACES}
